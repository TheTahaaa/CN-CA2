                                                     ...
                                                     for i in range(1, len(req_from_browser_list) - 2):
                                                         ...
                                                         req_header_dict[key_name] = value
                                                             ...
                                                             if req_header_dict['Host'] in notify_dict:
                                                                 ...
                                                                 if notify_dict[req_header_dict['Host']] == 'false':
                                                                     raise Exception
                                                                         else:
                                                                                                                                                                                 ...
                                                                                                                                                                                 quitMesg = 'QUIT\r\n'
                                                                                                                                                                                     ...
                                                                                                                                                                                     logging.info('Mail sent to the manager')
                                                                                                                                                                                         raise Exception
                                                                                                                                                                                             ...
                                                                                                                                                                                             #add cache
                                                                                                                                                                                             # if config_data['caching']['enable'] == 'true':
                                                                                                                                                                                             #     if req_line in cache:
                                                                                                                                                                                             #         logging.info('we have the response in cache!')
                                                                                                                                                                                             #         response_to_browser = cache.get(req_line)
                                                                                                                                                                                             #         # for key in cache.get(req_line):
                                                                                                                                                                                             #         #     response_to_browser += cache.get(req_line)[key]
                                                                                                                                                                                             #         #     response_to_browser += '\r\n'
                                                                                                                                                                                             #         #     if key == 'Content-length':
                                                                                                                                                                                             #         #         response_to_browser += '\r\n'
                                                                                                                                                                                             #         header_of_resp_to_proxy = response_to_browser.decode('utf-8', 'ignore').split('<!DOCTYPE html>')[0]
                                                                                                                                                                                             #         client.send(response_to_browser)
                                                                                                                                                                                             #         logging.info('\n''----------------------------------------------------------------------\n'
                                                                                                                                                                                             ...
                                                                                                                                                                                             #         continue
                                                                                                                                                                                             #     else:
                                                                                                                                                                                             #         logging.info('we dont have the response in cache!')
                                                                                                                                                                                             # add privacy part
                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                      resp_to_proxy = recv_all(sock2)
                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                          body_of_resp = '<!DOCTYPE html>' + body_of_resp
                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                              logging.info('\n''----------------------------------------------------------------------\n'
                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                           resp_header_dict = {}
                                                                                                                                                                                                                                                                               resp_header_dict['resp_line'] = resp_from_server_list[0]
